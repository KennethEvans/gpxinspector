...
public class GPXParser
{
    ...
    // private static String GPX_TRACKPOINTEXTENSIONV2_PACKAGE =
    // "net.kenevans.gpxtrackpointextensionv2";
     ...
     * @throws JAXBException
     */
    public static void print(String creator, GpxType gpx, OutputStream out)
        throws JAXBException {
    ...
    public static Gpx parse10(File file) throws JAXBException {
        Gpx gpx = null;
        net.kenevans.gpx10.ObjectFactory objectFactory = new net.kenevans.gpx10.ObjectFactory();
        JAXBContext jc = JAXBContext.newInstance(objectFactory.getClass());
        Unmarshaller unmarshaller = jc.createUnmarshaller();
